...
const ChangingPointsTable = () => {
  ...
  return (
    <div className="overflow-x-auto mx-5 text-center bg-gray-300">
        <h1 className='font-semibold text-[20px] underline mt-3'>Template for (Change Points to Calculate Profit/Loss)</h1>
      <table className="min-w-full bg-white border border-collapse border-black shadow-xl shadow-red-500 m-6">
        <thead>
          <tr className="bg-green-300">
            <th
              colSpan={2}
              className="py-2 px-3 text-center text-xs font-semibold uppercase border-b border-black border-l border-r"
            >
              {firstHeadings[0]}
            </th>
        ...
        <tbody>
          {data.map((row, index) => (
            ...
            >
              ...
              <td className="py-2 px-3 border-l border-r border-black font-bold">{row.pair}</td>
              ...
              <td className="py-2 px-3 border-l border-r border-black font-bold">{row.lotSize}</td>
              <td className="py-2 px-3 border-l border-r border-black font-bold">{row.openPrice}</td>
...
export default ChangingPointsTable;
