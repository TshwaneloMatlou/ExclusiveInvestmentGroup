...
const TopBanner = () => {
  return (
    ...
    >
      ...
      {/* Header content */}
      <div className="relative container justify-center mx-auto h-full flex items-center">
        <div className="text-center">
          ...
          <p className="text-lg text-white mb-4">Explore and discover amazing content.</p>
