...
const ChangeLotSizeTable = () => {
  ...
  return (
    <div className="overflow-x-auto mx-5 text-center bg-gray-300">
        <h1 className='font-semibold text-[20px] underline mt-3'>Template for (Change LotSize to Calculate Profit/Loss)</h1>
...
export default ChangeLotSizeTable;
